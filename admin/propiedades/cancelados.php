      ...
      <div class="card-content">
        ...
        <table>
          ...
          while ($f =$res->fetch_assoc()) {?>
            <tr>
              <td><button data-target="modal1" id="mod" value="<?php echo $f['propiedad'] ?>" class="btn-floating"><i class="material-icons">visibility</i></button></td>
              ...
              <td><a href="#" class="btn-floating red" onclick="swal({ title: 'Esta seguro que desea cancelar la propiedad?', text:'Al eliminarla no podra recuperarla', type: 'warning', showCancelButton: true, confirmButtonColor: '#3085d6', cancelButtonColor: '#d33', confirmButtonText: 'Si, eliminarlo!' }).then(function () {  location.href='eliminar_propiedad.php?id=<?php echo $f['propiedad'] ?>&foto=<?php echo $f['foto_principal'] ?>'; })"><i class="material-icons">delete_forever</i></a></td>
            </tr>
          <?php }
          $sel->close();
          $con->close();
